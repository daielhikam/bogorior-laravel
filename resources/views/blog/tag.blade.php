...
@section('title', 'Tag: ' . ucfirst($tag) . ' - Artikel Bogorior KitchenSet')
@section('description', 'Kumpulan artikel dengan tag ' . ucfirst($tag) . ' dari Bogorior KitchenSet.')

@section('content')
<!-- Hero Section -->
<section class="relative bg-gradient-to-r from-green-600 to-green-700 text-white py-12">
    <div class="container mx-auto px-4 text-center">
        <h1 class="text-3xl md:text-4xl font-bold mb-2">Tag: {{ ucfirst($tag) }}</h1>
        <p class="text-lg opacity-90">Kumpulan artikel dengan tag {{ ucfirst($tag) }}</p>
    </div>
</section>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div class="lg:col-span-2">
                ...
                <div class="text-center py-12 bg-white rounded-xl">
                    ...
                    <p class="text-gray-500">Belum ada artikel dengan tag "{{ ucfirst($tag) }}".</p>
